...
#define _DESCRIPTORS_H_
	...
	/* Macros: */
		/** Endpoint address of the My Usb device-to-host data IN endpoint. */
		#define VENDOR_IN_EPADDR               (ENDPOINT_DIR_IN  | 3)
        //ENDPOINT_DIR_IN=0x80=128 
		/** Endpoint address of the My Usb host-to-device data OUT endpoint. */
		#define VENDOR_OUT_EPADDR              (ENDPOINT_DIR_OUT | 4)
        //ENDPOINT_DIR_OUT   0x00
		/** Size in bytes of the My Usb data endpoints. */
		#define VENDOR_IO_EPSIZE               8

       //# define LED_CTRL_EPSIZE              8
